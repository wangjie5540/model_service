...
public enum SolutionErrorCode implements ErrorCode {
    ...
    SCENE_HAS_SOLUTION("SCENE_HAS_SOLUTION", "该场景下存在模型"),
    ...
    SOLUTION_NOT_FOUND("SOLUTION_NOT_FOUND", "模型没有找到"),
    SOLUTION_SERVING_NOT_FOUND("SOLUTION_SERVING_NOT_FOUND", "模型服务没有找到"),
    SOLUTION_NOT_EXECUTING("SOLUTION_NOT_EXECUTING", "模型没有在执行中"),
    SOLUTION_RUN_NOT_FOUND("SOLUTION_RUN_NOT_FOUND", "模型运行实例没有找到"),
    SOLUTION_NOT_PUBLISHED("SOLUTION_NOT_PUBLISHED", "模型未发布"),
    SOLUTION_PUBLISHED("SOLUTION_PUBLISHED", "模型已发布"),
    SOLUTION_EXECUTING("SOLUTION_EXECUTING", "模型执行中"),
    SOLUTION_HAS_SERVING("SOLUTION_HAS_SERVING", "模型已被服务使用"),
